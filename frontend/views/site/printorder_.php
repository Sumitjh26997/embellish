...
<div style="margin:10px;" id="cart_items">
					...
					<div class="col-sm-8 clearfix">
						<div class="bill-to">
							...
							<table>
								...
								<tr><td style="width: 100px;vertical-align: top;" class="tdr">Address:&nbsp;&nbsp;&nbsp;</td><td><textarea rows="8" style="width:200px;padding: 0px;">HARDCODEDHARDCODEDHARDCODEDHARDCODEDHARDCODEDHARDCODEDs</textarea></td></tr>
  					...
  					<div class="col-sm-4">
						<div class="shopper-info">
							<p style="font-weight: bolder;">Shopper Information</p>
								...
								<tr>
								<td class="tdr" style="vertical-align: top;">Company&nbsp;Address:&nbsp;&nbsp;&nbsp;</td><td><textarea rows="8" style="width:200px;padding: 0px;"><?=$accountuser->address?></textarea>
							</td></tr>
							</table>
						<br><br><br>
								<table>
								<tr style="font-weight: bolder;"><td class="tdr">Pickup Time:&nbsp;&nbsp;&nbsp;</td><td>PMMPMPMPMP</td></tr>
								</table>
								...
								<tbody>
									...
									<tr>
										<td class="cart_product">
											<p><img src="images/product-details/<?php echo $itemdetails->image ?>" height="50px" width="100px" alt="photo" /></p>
										</td>
										<td class="cart_description">
											<h4><a href=""></a><?=$itemdetails->name?></h4>
									...
									<?php $total=$total+$item->qty_per_item*$item->current_price; } ?>
										...
										<td colspan="2">
											<table class="table table-condensed total-result">
												<tr>
													...
													<td><i class="fa fa-inr "><?=$total?></i></td>
												</tr>
												<tr>
													<td>Exo Tax</td>
													<td>$0</td>
												...
												<tr>
													<td>Total</td>
													<td><span><i class="fa fa-inr "><?=$total?></i></span></td>
												</tr>
											</table>
										</td>
									</tr>
