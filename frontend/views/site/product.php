                            ...
                            <div class="product-information">
                                ...
                                <span>
                                  <table align="center">
                                    ...
                                    <td><span><i class="fa fa-inr"></i><?=$item->rent_per_day?></span></td></tr>
                                ...
                                <?php //if (!Yii::$app->user->isGuest) { ?> 
                                          ...
                                          <tr>
                                            ...
                                            <td><select name="quantity" value="<?=$todisplay?>" style="border:1px solid #331a00;background: none;">
                                              ...
                                              <td><button class="btn btn-default product-details" style="background:#331a00;color: white;" disabled="true"><i class="fa fa-shopping-cart"></i>&nbsp;Add to Cart</button></td>
