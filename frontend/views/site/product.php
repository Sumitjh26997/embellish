						...
						<!-- <div id="similar-product" class="carousel slide" data-ride="carousel"> -->
							<div class="carousel-inner">
								<div class="active item">
									<img  width="500px" height="300px" src="images/product-details/<?php echo $itemimages[0]->image ?>" width="200" height="50" alt="photo" />
								</div>
								<?php foreach($itemimages as $immg) {?>
								<div class="item">								
	                                        
	                             <img width="500px" height="300px" src="images/product-details/<?php echo $immg->image ?>"  alt="photo">                                                         													
								</div>
